...
public class ItemsController {
    ...
    public ModelAndView editItems(@RequestParam Integer id) {
    ...
    public ModelAndView updateItems(Integer id, @ModelAttribute(value = "item") Items item, MultipartFile pictureFile) throws Exception {
        ...
        // 获取图片的原始名称
            ...
            String newName = UUID.randomUUID()+name.substring(name.indexOf("."));
